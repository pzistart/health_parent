...
public class Menu implements Serializable{
    ...
    public Menu(Integer id, String name, String linkUrl, String path, Integer priority, String description, String icon, Set<Role> roles, List<Menu> children, Integer parentMenuId) {
        this.id = id;
        this.name = name;
